...
!function( $ ){
	...
	Confirm.prototype = {
		...
		,setModalTitle: function( text ) {
			$(this.getModal()).find('.modal-header h2').html( text );
		}
		// 设置modal内容
	...
	$.fn.confirm.defaults = {
		...
		template : '<div class="modal hide fade confirm-modal"><div class="modal-header"><h2></h2></div><div class="modal-body"></div><div class="modal-footer"><a href="#" class="btn btn-success confirm-btn">确定</a><a href="#" class="btn confirm-cancelbtn">取消</a></div></div>'
	}
