...
class MY_Form_validation extends CI_Form_validation 
{
    ...
    // My Validate reCAPTCHA
    protected function my_validate_recaptcha()
    {
		if (!$this->CI->flexi_auth->my_validate_recaptcha())
        {
			$status_message = $this->CI->lang->line('captcha_answer_invalid');
            //注意下方法的第一个参数必须与函数名称一致，否则会报错。
			$this->CI->form_validation->set_message('my_validate_recaptcha', $status_message);
			return FALSE;
        }
        return TRUE;
    }
