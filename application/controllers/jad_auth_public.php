...
class Jad_auth_public extends CI_Controller {
	...
	*/
	...
	function dashboard()
	{
		...
		$this->load->view('jadiiar/jad_public/dashboard_view', $this->data);
	}
	...
	function update_account()
	{
		...
		{
			$this->jad_auth_model->update_account();
		}else if ($this->input->post('change_password'))
		{
			$this->jad_auth_model->change_password();
		}
		...
		$this->load->view('jadiiar/jad_public/account_update_view_new', $this->data);
	}
	...
	function change_password()
	{
		...
		$this->load->view('jadiiar/jad_public/password_update_view', $this->data);
	}
